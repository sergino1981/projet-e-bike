...
function affichage(data) {
    ...
    for(let d in data){
        ...
        if(d == 4){ document.getElementById("descriNom").innerHTML = strNom;}
        if(d == 4){document.getElementById("descriPrix").innerHTML = strPrix;}
        if(d == 4){document.getElementById("descriDescription").innerHTML = strDescription;}
        if(d == 4){document.getElementById("descriCaracteristique").innerHTML = strCaracteristique;}
        if(d == 4){document.getElementById("descriCaracteristique").innerHTML = strCaracteristique;}
        if(d == 4){document.getElementById("descriCaracteristique2").innerHTML = strcaractéristiquesBis;}
    }
}
