...
function affichage(data) {
    ...
    for(let d in data){
        ...
        if(d == 2){ document.getElementById("descriNom").innerHTML = strNom;}
        if(d == 2){document.getElementById("descriPrix").innerHTML = strPrix;}
        if(d == 2){document.getElementById("descriDescription").innerHTML = strDescription;}
        if(d == 2){document.getElementById("descriCaracteristique").innerHTML = strCaracteristique;}
        if(d == 2){document.getElementById("descriCaracteristique").innerHTML = strCaracteristique;}
        if(d == 2){document.getElementById("descriCaracteristique2").innerHTML = strcaractéristiquesBis;}
    }
}
